					   ...
					   )
{
	...
	floatCodePhase = tBegin*10230e3;						// 计算起始的浮点码相位
	floatCodePhase = fmod(floatCodePhase,10230.0);		// 限制码相位为0-1022.999999999...
	deltaCodePhase = deltaT*10230e3;						// 计算样点间的码相位差
	...
	for (i=0;i<num;i++)//long num,		// 样点个数: input   nLocal  2毫秒的点数
	{
		...
		if (floatCodePhase >= 10230.0)
		{
			//floatCodePhase -= 2046.0;
			floatCodePhase -= 10230.0;
		}
	}
}
