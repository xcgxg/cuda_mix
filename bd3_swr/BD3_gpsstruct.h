...
#ifndef BD3_GPS_STRUCT_H
#define BD3_GPS_STRUCT_H
...
typedef struct
{
	...
	// 以下一组变量仅用于位同步
	long IBuf[BD3_BUFSIZE];					// 用于缓存I通道的值
	long QBuf[BD3_BUFSIZE];					// 用于缓存Q通道的值
	char signBuf[BD3_BUFSIZE];				// 缓存IQ通道的符号变化
...
////////////////////////////////////////////////////
	...
	int fifo[BD3_FIFO_NUM]; //相关器
	int v[BD3_FIFO_NUM];    //每相关器输出值
	int p;
